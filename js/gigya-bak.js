...
;(function ( $, win, doc, undefined ){
	...
	*/
    gigya.updateDesktopStatus = function(){
    		console.log("assumming after login");
           // gigya.elements.login.hide(); 
		...
		if($.cookie("gigya-UID")){     // sign in
				...
				gigya.elements.customerName.text("Ktao");
			...
			//	$.cookie("gigya-avatar",  "https://graph.facebook.com/v2.3/705361019519756/picture?type=square", {path:"/", expires: cookieExpired});
			if (!$.cookie("gigya-avatar")){
				...
				gigya.elements.gigya_avatar.find(".avatar-img").attr("src","https://graph.facebook.com/v2.3/705361019519756/picture?type=square").show();
			}else{
   ...
   */
	...
	gigya.welcomePageSlideIn = function(eventObj,SlideType){
		if (gigya.params.domainUrl === "http://uat.iseldev.com" ) {gigya.params.domainUrl = "http://10.153.240.181"; } // for uat testing as the domain of iselect core on wordpress is inconsistent with sale funnel; 
